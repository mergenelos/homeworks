...
grid on;hold on;
title("LS parameter estimation - Underparameterized system");xlabel('Sample Number');ylabel('Amplitude');

%% Recreate system model
sysCSD = tf(theta_hat(3:4)',[1 theta_hat(1:2)'],0.3)
sysCS = d2c(sysCSD)